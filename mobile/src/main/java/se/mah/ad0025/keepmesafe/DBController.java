...
public class DBController extends SQLiteOpenHelper {
     ...
     *
     * @return A Cursor with all the active contacts.
     */
     ...
     *
     * @param name   the name we want to store.
     * @param number the number to the contact.
     */
     ...
     *
     * @param db The database we want the tables to be in.
     */
    @Override
